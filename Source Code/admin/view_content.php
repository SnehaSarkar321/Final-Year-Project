...
<section class="view-content">
   ...
   <div class="container">
      ...
      <div class="date"><i style=" color: #1abc9c;" class="fas fa-calendar"></i><span><?= $fetch_content['date']; ?></span></div>
      <h3 class="title"><?= $fetch_content['title']; ?></h3>
      <div class="flex">
         <div><i style="color:red;" class="fas fa-heart"></i><span><?= $total_likes; ?> Likes</span></div>
         <div><i style=" color: #f7c94b;" class="fas fa-comment"></i><span><?= $total_comments; ?>  Comments </span></div>
      </div>
...
<section class="comments">
   ...
   <h1 style="margin-top: 3rem;"  class="heading">user comments</h1>
