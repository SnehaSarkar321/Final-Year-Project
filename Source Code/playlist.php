...
<section class="playlist">
   ...
   <h1 style="margin-top:3.2rem;" class="heading">playlist details</h1>
   ...
   <div class="container row">
      ...
      <div class="col">
         <div class="tutor">
            ...
            <div>
               <h3>Created by : <?= $fetch_tutor['name']; ?></h3>
               <span>Profession : <?= $fetch_tutor['profession']; ?></span>
            </div>
         </div>
         <div class="details">
            <h3>Playlist title: <?= $fetch_playlist['title']; ?></h3>
            <p class="description"style="margin-top: 20px">Description: <?= $fetch_playlist['description']; ?></p>
            <div class="date">Created on: <br><i class="fas fa-calendar"></i><span><?= $fetch_playlist['date']; ?></span></div>
         </div>
...
<section style="margin-bottom:4rem;" class="videos-container">
...
<script>
   document.querySelectorAll('.description').forEach(content => {
      if(content.innerHTML.length > 100) content.innerHTML = content.innerHTML.slice(0, 300);
   });
</script>
</body>
</html>