...
<section style="margin-top: 4rem;" class="liked-videos">
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="main_btn inline-btn">watch video</a>
         <input type="submit" value="remove video" class="main_btn inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
      ...
      <div class="div-empty">
            <img src=" '.$ip .'" alt="">
            <p >nothing added to likes yet!</p>
      </div>
      ';
